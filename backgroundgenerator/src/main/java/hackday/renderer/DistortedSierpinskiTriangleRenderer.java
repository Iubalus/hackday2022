...
public class DistortedSierpinskiTriangleRenderer implements ImageRenderer<DistortedSierpinskiTriangleRenderer.R> {

    public BufferedImage render(DistortedSierpinskiTriangleRenderer.R params) {
...
//        thatKindaCoolTho(graphics, params.getBase()/2, params.getWidth()/2, pointPositionY, 15);
    ...
    public static class Factory implements RendererFactory<DistortedSierpinskiTriangleRenderer, R> {
        public DistortedSierpinskiTriangleRenderer create() {
            return new DistortedSierpinskiTriangleRenderer();
        }
